...
final class AppModel: ObservableObject {
    ...
    func updateProfile(_ profile: ServerProfile) {
        ...
        normalized.managementURL = normalized.managementURL.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    var coreRestartAvailable: Bool {
        guard let profile = selectedProfile else { return false }
        return profile.hasControllerEndpoint || managementFeaturesAvailable
    }
