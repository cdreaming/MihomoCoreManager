...
These rules were proven by the successful v1.2.5 release baseline and are mandatory for v1.2.8. They were promoted from the
...
`RELEASE-HARDENING-v1.2.6.md` are included in the final v1.2.8 source manifest.
...
(`arm64-apple-macos14.0` for v1.2.8). The authoritative full compile remains
`xcodebuild`.
