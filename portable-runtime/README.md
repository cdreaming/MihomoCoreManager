...
- v1.1.3 使用 Mihomo Core 管理面板 v4.0.0 Dashboard UI，并继续保留 v1.0.7 菜单栏 JXA 启动稳定性保护。
...
正式 GitHub Release 仍由 `.github/workflows/release.yml` 在 macOS arm64 Runner 上构建 SwiftUI App；v1.1.3 默认使用无需 Apple Developer 凭据的 `--unsigned` 发布路径。
