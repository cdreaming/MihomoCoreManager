...
- v1.0.9 使用 Mihomo Core 管理面板 v4.0.0 Dashboard UI，并继续保留 v1.0.7 菜单栏 JXA 启动稳定性保护。
...
正式 Release 仍由 `.github/workflows/release.yml` 在 macOS arm64 Runner 上构建 SwiftUI App，并完成 Developer ID 签名、公证和 `.pkg` 发布。
