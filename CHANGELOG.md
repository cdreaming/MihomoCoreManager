...
- 以 `MihomoCoreManager-v1.2.5-release-ready-source-4` 为功能基线，直接升级正式版本号，不改动既有业务功能。
- App / Xcode / portable runtime 统一升级为 v1.2.7 / build 127。
- portable 版本回归测试更新为 v1.2.7 / build 127。
- 发布 workflow 输入示例、正式资产命名、发布说明与验证文档同步到 v1.2.7。
- 重新生成源码 SHA-256 manifest，保证发布源码清单与实际文件一致。
